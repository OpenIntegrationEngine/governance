...
The list of contributors is recorded publicly in the `governance` repository in `contributors.md`.
...
- New Contributors may self-select by submitting a PR to the `contributors.md` document in the `governance` repo
